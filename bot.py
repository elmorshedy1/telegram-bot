...
# Since we're having issues with environment variables, we'll use direct values
API_ID = 26260611
API_HASH = "4082e4330bf95c8d9c7cf61b022065d2"
BOT_TOKEN = "8132700078:AAGiGsTvpxRdKetWTnSkwe0A_25ZJz0jqRA"

# Debug logging
logger.info(f"Using API_ID: {API_ID}")
logger.info(f"Using API_HASH: {API_HASH}")
logger.info(f"Using BOT_TOKEN: {BOT_TOKEN[:10]}...{BOT_TOKEN[-5:]}")
...
if not all([API_ID, API_HASH, BOT_TOKEN]):
    ...
    raise ValueError("Missing required environment variables. Please set TELEGRAM_API_ID, TELEGRAM_API_HASH, and TELEGRAM_BOT_TOKEN")
